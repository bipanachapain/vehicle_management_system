    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('vehicle.types') ? 'active' : '' }}" href="{{ route('vehicle.types') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('admin.messages') ? 'active' : '' }}" href="{{route('admin.messages')}}">
            ...
            <span class="nav-link-text ms-1">Message Manage</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('admin.document.types') ? 'active' : '' }}" href="{{ route('admin.document.types') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
             ...
             @csrf
                    <button type="submit" class="nav-link btn btn-link d-flex align-items-center w-100 text-start p-0">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('vehicle.types') ? 'active' : '' }}" href="{{ route('vehicle.types')}}">
            ...
            <span class="nav-link-text ms-1"> Vehicles Type</span>
          </a>
        </li>
        <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('admin.messages') ? 'active' : '' }}" href="{{ route('admin.messages') }}">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('admin.document.types') ? 'active' : '' }}" href="{{ route('admin.document.types') }}">
            ...
            <span class="nav-link-text ms-1">Document Manage</span>
          </a>
        </li>
        ...
        {{-- <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('user.roles') ? 'active' : '' }}" href="{{ route('user.roles') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
             <i class="ni ni-circle-08 text-dark text-sm opacity-10"></i>
            </div>

...
<main class="main-content position-relative border-radius-lg ">
    ...
    {{-- Sidebar --}}
    {{-- <div class="w-64  h-screen p-4 flex flex-col">
        ...
        <nav class="space-y-4">
            ...
            <a href="{{route('vehicles.index')}}" class="block px-3 py-2 rounded hover:bg-gray-700">My Vehicles</a>
            <a href="" class="block px-3 py-2 rounded hover:bg-gray-700">Renewals</a>
            <a href="" class="block px-3 py-2 rounded hover:bg-gray-700">Notifications</a>
        </nav>
    </div> --}}
